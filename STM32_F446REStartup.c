...
void Reset_Handler(void)
{
    ...
    /* 1. Copy .data section from flash to to SRAM */
    uint8_t *SrcPtr = (uint8_t*)&_etext;    /* Start of .data section in flash*/
    uint8_t *DesPtr = (uint8_t*)&_sdata;    /* Start od .data section in SRAM*/
    ...
    /* 3. (Optional) Call  init  function of standard library i.e : printf ,scanf */
